                            ...
                            foreach ($line as $key => $value) {
                                ...
                                <td><span class="line_data"><?php
                                    ...
                                    <?php if (substr($key, -2) != 'Id') { ?>
                                        <input class="line_data <?php echo "{$table}_input_{$id}" ?> unviewed_mode" type="<?php echo $data[$key][0] ?>" value="<?php echo $value; ?>" <?php echo ($data[$key][0] == 'checkbox' && $value == 1) ? 'checked' : ''; ?>>
                                        <?php
                                    } else {
                                        $id = $value;
                                    }
